...
class TransactionData {
  ...
  TransactionData(this.m_id, this.m_transDate, this.m_method, this.m_usage,
      this.m_value, this.m_note) {}
  ...
  TransactionData clone() {
    return TransactionData(this.m_id, this.m_transDate, this.m_method,
        this.m_usage, this.m_value, this.m_note);
  }
